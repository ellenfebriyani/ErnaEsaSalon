export default function PageBanner({ title, img }) {
  return (
    <div
      className="relative h-56 md:h-72 flex items-center justify-center bg-cover bg-center"
      style={{ backgroundImage: `linear-gradient(rgba(88,0,28,0.45), rgba(88,0,28,0.45)), url(${img})` }}
    >
